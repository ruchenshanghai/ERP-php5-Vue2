var curRow, curCol, curArrears, loading, urlParam = Public.urlParam(),
    ...
    THISPAGE = {
        ...
        loadGrid: function (a) {
            function b(a, b, c) {
                return r(b.rowId), a ? a :
                    c.invNumber ? c.invSpec ? c.invNumber + " " + c.invName + "_" + c.invSpec :
                        c.invNumber + " " + c.invName : "&#160;"
            }
                    ...
                    if (urlParam.id > 0 || urlParam.cacheId) {
                        ...
                        for (var d = 0; c > d; d++) {
                            ...
                            Business.cacheManage.getGoodsInfoByNumber(f.number, function (a) {
                                f.isSerNum = a.isSerNum, f.isWarranty = e.isWarranty = a.isWarranty, f.safeDays = e.safeDays = a.safeDays, f.id = e.invId,
                                    $("#" + b[d].id).data("goodsInfo", f).data("storageInfo", {
                                        id: e.locationId,
                                        name: e.locationName
                                    }).data("unitInfo", {
                                        unitId: e.unitId,
                    ...
                    if ("goods" === b) {
                        ...
                        var e, f = function (b) {
                            SYSTEM.ISSERNUM && b.isSerNum ? (Business.serNumManage({
                                row: $("#" + a),
                                data: b
                            }), e = "&#160;") : b.skuClassId && SYSTEM.enableAssistingProp ?
                                (Business.billSkuManage($("#" + a), b), e = "&#160;")
                        ...
                        return THISPAGE.$_barCodeInsert && THISPAGE.$_barCodeInsert.hasClass("active") ?
                            Business.cacheManage.getGoodsInfoByBarCode(c, f, !0)
                            : Business.cacheManage.getGoodsInfoByNumber(c, f, !0), e ? e : ($.dialog({
                            width: 775,
                            height: 510,
                            title: "选择商品",
                ...
                afterSaveCell: function (a, b, c) {
                    switch (b) {
                        ...
                        case "prodDate": {
                            ...
                            g && (g.addDays(Number(d.safeDays || f.safeDays)), f.validDate = g.format()),
                                $("#grid").jqGrid("setRowData", a, f);
                        }
                            break;
                        //jasonxie add 2017/11/24
                        case "locationName": {
                            $("#" + a).data("storageInfo", {
                                id: parent.Public.ToStorageId(c),
                                name: c
                            });
                        }
                            break;
        ...
        reloadData: function (a) {
            function b() {
                c.$_customer.data("contactInfo", {
                    ...
                    c.$_date.val(a.date), c.$_number.text(a.billNo),
            ...
            $("#grid").jqGrid("setGridParam", {
                ...
                cellEdit: !0,
                datatype: "clientSide"
            }).trigger("reloadGrid"), b(),
                "edit" === a.status ? this.editable ||
                    (this.customerCombo.enable(),
                        this.$_date.removeAttr("disabled"),
                        this.editable = !0,
                        this.$_toolBottom.html(c.btn_edit + c.btn_audit),
                        $("#mark").removeClass("has-audit")) :
                    this.editable && (this.customerCombo.disable(),
                        this.$_date.attr("disabled", "disabled"),
                        this.editable = !1, $("#groupBtn").html(c.btn_view + c.btn_reaudit),
