...
class Data_model extends CI_Model{
    ...
    public function get_order_info($where='',$type=2) {
        $sql = 'select
		            a.*,
					b.name as invName, b.number as invNumber, b.spec as invSpec, b.unitName as mainUnit,b.remark as remark,b.manufacture as manufacture,
				...
				from '.ORDER_INFO.' as a
					left join
						(select
							id,name,number,spec,unitName,currency,remark,manufacture
						from '.GOODS.'
						where (isDelete=0)
						order by id desc) as b
					on a.invId=b.id
