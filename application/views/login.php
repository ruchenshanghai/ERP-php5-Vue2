...
<html>
    <head>
        ...
        <script src="<?php echo base_url()?>statics/login/Scripts/minijs/md5.js"></script>
...
<script type="text/javascript">
    ...
    $(window).load(function(){
        $('.loading').hide();
        var defaultpass = "<?php echo get_cookie('userpwd')?>";
        $("#password").val(defaultpass);
    });
    function md5PWD(password){
        if(password.substring(0,5)=="&md5;"){
